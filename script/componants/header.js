...
export default class Header extends ManageDom {
  ...
  render() {
    ...
    const headLogo = this.createMarkup("img", "", header, [
      { src: "../../assets/logo_client.png" },{ width: "150"}, {height: "auto"},{style: "z-index: 0;"}
    ]);
    ...
    const gif = this.createMarkup("img", "", divGif, [
      { src: "../../assets/logo_client_v2.gif" },{ width: "80"}, {height: "auto"}, 
    ...
    const nav = this.createMarkup("nav", "", header, [
      { style: "margin-bottom:50px ;width:80%; display: flex; flex-direction: row; justify-content: space-around; z-index: 0; font-family: epilogue; font-size: 16px;"}
    ]);

    const accueil = this.createMarkup("a", "Accueil", nav, [
      { href: ""}, {style: "text-decoration: none; color: white; z-index: 0;"}
    ]);
    ...
    const title = this.createMarkup("span", "Vélomobiles français", header, [
      {style: "font-size: 18px; color: white; z-index: 0; font-family: epilogue;"}
    ]);
    ...
    const contactButton = this.createMarkup("a", "Nous contacter", bottomDiv, [
      {style: "position: relative; bottom: -45px; width: 200px ; height: 30px; font-size: 12px; color: white; background-color: #cc0000; border: none; text-decoration: none; text-align: center; items-align: center; line-height: 30px; left:5%; font-family: epilogue"},
      { href : "./index.html"}
    ]);
