...
export default class Header extends ManageDom {
  ...
  render() {
    const header = this.createMarkup("header", "", document.body, [
      {
        style:
          "margin-bottom: 50px; width:100%; height: 335px; display:flex; flex-direction: column; align-items: center;  background-image: url('./../../assets/imgs/background.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; margin-top: 0px; position: relative;",
      },
    ]);
    ...
    const contactButton = this.createMarkup("a", "Nous contacter", bottomDiv, [
      {
        style:
          "position: absolute; bottom: 10px; width: 230px ; height: 40px; font-size: 20px; color: white; background-color: #cc0000; border: none; text-decoration: none; text-align: center; items-align: center; line-height: 40px; left:5%; font-family: epilogue",
      },
      { href: "../../html/contact.html" },
      { class: "contactButton" }
    ...
    const border = this.createMarkup("div", "", header, [
      {
        style:
          "position: absolute; bottom: 0; width: 100%; height: 20px; background-color: #007dcc;",
      },
      { class: "border" }
    ]);
  }
