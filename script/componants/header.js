...
export default class Header extends ManageDom {
  ...
  render() {
    ...
    const headLogo = this.createMarkup("img", "", header, [
      { src: "../../assets/logo_client.png" },{ width: "300"}, {height: "auto"},
    ]);
    const gif = this.createMarkup("img", "", header, [
      { src: "../../assets/logo_client_v2.gif" },{ width: "150"}, {height: "auto"}, { style: "position: relative; justify-content: initial; align-items: initial;"},
    ]);
    const hr = this.createMarkup("hr", "", header, [
      { style: "width:80%; color: white;"}
    ]);
    const nav = this.createMarkup("nav", "", header, [
      { style: "width:100%; height: 150px; display: flex; flex-direction: row; justify-content: center"}
    ]);
    const accueil = this.createMarkup("a", "Accueil", nav, [
      { href: ""}, {style: "font-size: 30px; margin: 0 20px; text-decoration: none; color: white;"}
    ]);
